...
def call_deepseek(material_text: str, today_str: str) -> str:
    ...
    prompt = f"""
今天是：{today_str}（北京时间）。
你是我的企业AI赋能助理，请输出“每周政策与成都AI简报”。必须遵守规则：
- 所有要点必须带【链接】（从素材中引用，不要编造）
- 不允许输出错误年份/日期；日期必须是 {today_str}
- 信息密度高，短句，秘书口吻，不空泛
...
【1) 经济政策 Top 5】
- 每条：一句话概括 + 影响对象（创业者/中小企业/ToB服务商/高校等）+ 我该怎么用（1句话）+ 链接
...
def main():
    ...
    econ_feeds = [
        ...
        "https://news.google.com/rss/search?q=%E7%A8%8E%E6%94%B6%20%E4%BC%98%E6%83%A0%20%E6%94%BF%E7%AD%96%20%E9%80%9A%E7%9F%A5&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
    ]
    ...
    # --- 成都AI政策（更偏“政策/扶持/通知/征求意见”） ---
    chengdu_ai_policy_feeds = [
        "https://news.google.com/rss/search?q=%E6%88%90%E9%83%BD%20AI%20%E6%94%BF%E7%AD%96%20%E9%80%9A%E7%9F%A5&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        "https://news.google.com/rss/search?q=%E6%88%90%E9%83%BD%20%E9%AB%98%E6%96%B0%E5%8C%BA%20AI%20%E6%89%B6%E6%8C%81%20%E6%94%BF%E7%AD%96&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        "https://news.google.com/rss/search?q=%E5%A4%A9%E5%BA%9C%E6%96%B0%E5%8C%BA%20AI%20%E6%94%BF%E7%AD%96%20%E6%89%B6%E6%8C%81&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
    ]

    # --- 成都AI新闻动态（更偏“项目/企业/活动/算力/大模型”） ---
    chengdu_ai_news_feeds = [
        "https://news.google.com/rss/search?q=%E6%88%90%E9%83%BD%20AI%20%E4%BA%A7%E4%B8%9A%20%E9%A1%B9%E7%9B%AE&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        ...
        "https://news.google.com/rss/search?q=%E6%88%90%E9%83%BD%20AI%20%E6%B4%BB%E5%8A%A8%20%E5%A4%A7%E4%BC%9A&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        "https://news.google.com/rss/search?q=%E6%88%90%E9%83%BD%20%E4%BA%BA%E5%B7%A5%E6%99%BA%E8%83%BD%20%E4%BC%81%E4%B8%9A%20%E8%9E%8D%E8%B5%84&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
    ]
    ...
    for u in chengdu_ai_policy_feeds:
        cd_policy_items.extend(read_feed(u, limit=10))
    for u in chengdu_ai_news_feeds:
        cd_news_items.extend(read_feed(u, limit=10))

    econ_items = dedup(econ_items)[:15]
    ai_items = dedup(ai_items)[:15]
    cd_policy_items = dedup(cd_policy_items)[:15]
    cd_news_items = dedup(cd_news_items)[:20]

    # 组装素材
    material = "\n\n".join([
        block("经济政策素材（全国）", econ_items),
        block("AI政策素材（全国）", ai_items),
        block("成都AI政策素材", cd_policy_items),
        block("成都AI新闻动态素材", cd_news_items),
    ])
